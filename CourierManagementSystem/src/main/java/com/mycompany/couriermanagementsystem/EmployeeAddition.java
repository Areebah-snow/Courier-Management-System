...
public class EmployeeAddition extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EMPLOYEE ADDITION");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int Emp_id=  Integer.parseInt(jTextField4.getText());
        String emp_name = jTextField3.getText();
        String emp_address = jTextField5.getText();
        long Emp_phone =Integer.parseInt(jTextField2.getText());
         
        
        DBConnect dbc = new DBConnect();
        
        JOptionPane.showMessageDialog(this,dbc.connectAndInsert(Emp_id, emp_name, emp_address, Emp_phone));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeAddition().setVisible(true);
            }
        });
    }
